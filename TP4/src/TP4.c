				...
				"\nError, reintente.",1,15,99)==0)
    	{
    		switch(opcion)
    		{
    		  ...
    		  case 5:
    			  ...
    			  {
    				  menuListados(listaJugadores,listaSelecciones,listaClonada);
    			  }else{
    		  ...
    		  case 11:
    			  if(ll_isEmpty(listaJugadores)==0)
    			  {
    				  ...
    				  printf("\nNo se puede copiar porque la lista original esta vacia!\n");
    			  }system("PAUSE");
    			  break;
    		  case 12:
    			  if(ll_isEmpty(listaClonada)==0 && ll_deleteLinkedList(listaClonada)==0){
    				  printf("\nLista eliminada!\n");
    			  }else{
    				  printf("\nERROR: No hay nada que eliminar!\n");
    			  }system("PAUSE");
    			  break;
    		  case 13:
    			  if(ll_isEmpty(listaClonada)==0)
    			  {
    				  if(ll_containsAll(listaJugadores,listaClonada)==1)
    				  {
    					  printf("\nLa lista clonada esta sin cambios de la original!");
    				  }
    				  else
    				  {
    				  printf("\nLa lista clon difiere a la original!");
    				  }
    			  }else{
    				  printf("\nError: La lista clonada no fue creada aun!");
    			  }system("PAUSE");
    			  break;
    		  case 14:
